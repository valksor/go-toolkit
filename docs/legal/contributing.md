...
Thank you for your interest in contributing to go-toolkit! This document provides guidelines for contributing to the project.
...
import (
    ...
    "github.com/valksor/go-toolkit/cache"  // local
)
```
...
- Add TTL-based expiration with lazy expiration
- Include background cleanup scheduler
...
- `feature/cache-ttl-support`
- `fix/envconfig-validation`
- `docs/update-readme`
...
When adding new packages to go-toolkit:
...
4. Update the main README.md with package description
5. Add documentation to `docs/packages/{packagename}.md`
6. Update `docs/_sidebar.md` to include the new package

### Package Guidelines

- Keep packages focused on a single responsibility
- Follow Go naming conventions
- Provide clear examples in godoc comments
- Ensure thread-safety where applicable
- Include benchmark tests for performance-critical code

## Documentation

Documentation is maintained in the `docs/` directory using Docsify:
...
- Package documentation in `docs/packages/`
- Usage examples in `docs/quickstart.md`
...
By contributing to go-toolkit, you agree that your contributions will be licensed under the [BSD 3-Clause License](license.md).

The full contributing guide is also available in the [CONTRIBUTING.md](https://github.com/valksor/go-toolkit/blob/master/CONTRIBUTING.md) file in the repository root.
