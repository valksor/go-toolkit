// Package naming provides utilities for extracting information from filenames
// and working with naming conventions common in project management tools.
//
// This package recognizes common patterns like:
//   - Ticket IDs: FEATURE-123, BUG-456, JIRA-789
//   - Type prefixes: feature-auth, fix-login, docs-api
//
// Basic usage:
//
//	taskType := naming.TaskTypeFromFilename("FEATURE-123.md") // "feature"
//	key := naming.KeyFromFilename("fix-login-bug.md")         // "fix-login-bug"
//	ticketID, ok := naming.ParseTicketID("JIRA-456-extra")    // "JIRA-456", true
package naming
...
// TypePrefixes are known type prefixes for task classification.
