// Package chart provides ASCII chart rendering for CLI tools.
//
// This package generates ASCII-based visualizations including bar charts,
// line charts, and pie charts that can be displayed in terminal environments.
//
// Basic usage:
//
//	bars := []chart.Bar{
...
//	}
//	fmt.Println(chart.BarChart(bars, chart.Options{Title: "Sales"}))
package chart
...
// DataPoint represents a single point in a line chart.
type DataPoint struct {
	Label string
	Value int
}

// Slice represents a single slice in a pie chart.
type Slice struct {
	Label   string
	Value   int
	Percent float64
...
// BarChart generates an ASCII bar chart.
func BarChart(bars []Bar, opts Options) string {
...
// LineChart generates an ASCII line chart showing trends over time.
func LineChart(dataPoints []DataPoint, opts Options) string {
	var sb strings.Builder
...
// PieChart generates an ASCII pie chart.
func PieChart(slices []Slice, opts Options) string {
	var sb strings.Builder
